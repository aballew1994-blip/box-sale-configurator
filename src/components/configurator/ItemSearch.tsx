...
interface ItemSearchProps {
  configId: string;
  onItemAdded: (config: Configuration) => void;
}

export function ItemSearch({ configId, onItemAdded }: ItemSearchProps) {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["itemSearch", debouncedQuery],
